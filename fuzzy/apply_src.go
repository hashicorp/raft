...
// Create a new source, any source created with the same seed will generate the same sequence of data.
...
// Resets this source back to its initial state, it'll generate the same sequence of data it initally did
