...
// Index of entry in the log. Log entries are counted starting at 1.
type Index uint64

// Term counts the number of Raft election cycles, starting at 1. There is at
...
type LogStore interface {
	...
	GetLog(index Index, log *Log) error
	...
	DeleteRange(min, max Index) error
}
